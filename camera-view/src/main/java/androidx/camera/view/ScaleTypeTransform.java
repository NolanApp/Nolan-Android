...
final class ScaleTypeTransform {
     ...
     * @param view       A child {@link View} of {@code container}.
     ...
     * @param container A parent {@link View} that wraps {@code view}.
     * @param view      A child {@link View} of {@code container}.
     * @return A {@link Point} whose coordinates represent the top left of
    ...
    /**
     * Computes the rotation of a {@link View} in degrees from its natural
     * orientation.
     */
