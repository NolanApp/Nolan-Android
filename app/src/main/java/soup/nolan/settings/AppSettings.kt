...
class AppSettingsImpl(context: Context) : AppSettings {
    ...
    override var showFilterEditor: Boolean by BooleanPreference(prefs, "show_filter_editor", true)
    override var lensFacingFront: Boolean by BooleanPreference(prefs, "lens_facing_front", true)
    override var lastFilterId: String by StringPreference(prefs, "last_filter_id", CameraFilter.default.id)
