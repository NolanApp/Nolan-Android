...
class AutoFitPreviewBuilder private constructor(
    ...
    private var viewFinderRotation: Int = Surface.ROTATION_0
    ...
    companion object {
         ...
         * config changes.
         */
        fun build(config: PreviewConfig, viewFinder: TextureView): Preview {
            return AutoFitPreviewBuilder(config, WeakReference(viewFinder)).useCase
        }
    }
}
